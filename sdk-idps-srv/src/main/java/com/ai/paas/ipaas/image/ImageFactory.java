...
public class ImageFactory {
    ...
    private static final String SEARCH_CONFIG_PATH = "/IDPS/";
    ...
    public static IImageClient getClient(AuthDescriptor ad) throws Exception {
        ...
        configM = JsonUtil.fromJson(imageConfig, configM.getClass());
        ...
        Map<String, String> configMO = null;
        configMO = JsonUtil.fromJson(imageUrlOutM, Map.class);
